...
Figur \ref{Billeder:figur1} viser simuleringen af 1. ordens lavpasfilter. På oscilloskopet vises kurveformen for $V_{out}$ og heraf bestemmes tidskonstan for R = 10 k$\Omega}$ og R = 100k$\Omega$.
I de to tilfælde bestemmes den maksimale værdi af $V_{out}$
Resultaterne indføres i tabel 1.

\begin{figure}[h]
 \begin{center}
  \includegraphics[height=5cm{Billeder/figur1}
...
\begin{figure}[h]
 \begin{center}
  \includegraphics[height=5cm]{Billeder/figur3.10k.50Hz.tau}
...
\begin{figure}[h]
 \begin{center}
  \includegraphics[height=5cm]{Billeder/figur6.100k.5Hz.tau}
  \caption{måling af $\tau$}
  \label{100k.5Hz.tau}
 \end{center}
\end{figure}
...
\begin{figure}[h]
 \begin{center}
  \includegraphics[height=5cm]{Billeder/figur7.100k.5Hz.stigetid}
  \caption{stigetid}
...
\begin{figure}[h]
 \begin{center}
  \includegraphics[height=5cm]{Billeder/figur5.100k.5Hz.min.max}
  \caption{Maksimal spænding}
